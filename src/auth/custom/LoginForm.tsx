...
export const LoginForm = ({ className, ...props }: React.ComponentProps<"div">) => { 
    ...
    const handleSubmit = async(event:React.FormEvent<HTMLFormElement>)=>{
       ...
       const email = formToSend.get('email') as string;
       const password = formToSend.get('password') as string;
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}  >
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground">Ingresa con tu cuenta</p>
              </div>
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <Link to={'/auth/login'} className="ml-auto text-sm underline-offset-2 hover:underline">
